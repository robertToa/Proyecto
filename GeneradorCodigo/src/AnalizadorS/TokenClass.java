...
public class TokenClass{
	...
	public boolean PalabraReservada(String texto){
		Pattern pat = Pattern.compile("if|then|else|while|do");
	...
	public boolean PalabrasReservadas2(String texto){
		Pattern pat = Pattern.compile("input|output|return");
		Matcher mat = pat.matcher(texto);
		if (mat.matches()) {
			return true;
		} else {
	...
	public boolean PalabrasReservada1(String texto){
		Pattern pat = Pattern.compile("int:|float:|bool:|char:|string:");
		Matcher mat = pat.matcher(texto);
		if (mat.matches()) {
			return true;
		} else {
	...
	public boolean OperadoresAsignacion(String texto){
	...
	public boolean entero(String texto){
